...
SET AUTOCOMMIT=0;
INSERT INTO Retailers VALUES ('RET001','AMUL','AND',50,30000.00,'GUJ'),
('RET002','SHREEJI STORES','SUR',50,30000.00,'GUJ'),
('RET003','BIG BAZAAR','SUR',100,100000.00,'GUJ'),
('RET004','KRISHNA GROCERIES','AND',25,30000.00,'GUJ'),
('RET005','YADAV GENERAL STORE','KUT',15,10000.00,'GUJ'),
('RET006','SHREE KUBER STORE','SUR',25,30000.00,'GUJ');
COMMIT;

SET AUTOCOMMIT=0;
INSERT INTO Batch VALUES ('BAT001','SUR',10,1000.00,'KUT'),
('BAT002','SUR',20,2000.00,'AND'),
('BAT003','SUR',30,4000.00,'AND'),
('BAT004','AND',40,9000.00,'AND'),
('BAT005','AND',50,10000.00,'SUR'),
('BAT006','KUT',20,3000.00,'SUR');
COMMIT;
...
SET AUTOCOMMIT=0;
INSERT INTO PW VALUES ('PW001','2022-12-31',20000.00,'SUR'),
('PW002','2022-12-31',20000.00,'SUR'),
('PW003','2022-12-31',20000.00,'SUR'),
('PW004','2022-12-31',20000.00,'SUR'),
('PW005','2022-12-31',20000.00,'SUR'),
('PW006','2022-12-31',20000.00,'SUR'),
('PW007','2022-12-31',20000.00,'SUR'),
('PW008','2022-12-31',20000.00,'SUR'),
('PW009','2022-12-31',20000.00,'SUR'),
('PW010','2022-12-31',20000.00,'SUR'),
('PW011','2023-01-31',20000.00,'KUT'),
('PW012','2023-01-31',20000.00,'KUT'),
('PW013','2023-01-31',20000.00,'KUT'),
('PW014','2023-01-31',20000.00,'KUT'),
('PW015','2023-01-31',20000.00,'KUT'),
('PW016','2023-01-31',20000.00,'KUT'),
('PW017','2023-01-31',20000.00,'KUT'),
('PW018','2023-01-31',20000.00,'KUT'),
('PW019','2023-01-31',20000.00,'KUT'),
('PW020','2023-01-31',20000.00,'KUT'),
('PW021','2023-02-01',20000.00,'AND'),
('PW022','2023-02-01',20000.00,'AND'),
('PW023','2023-02-01',20000.00,'AND'),
('PW024','2023-02-01',20000.00,'AND'),
('PW025','2023-02-01',20000.00,'AND'),
('PW026','2023-02-01',20000.00,'AND'),
('PW027','2023-02-01',20000.00,'AND'),
('PW028','2023-02-01',20000.00,'AND'),
('PW029','2023-02-01',20000.00,'AND'),
('PW030','2023-02-01',20000.00,'AND');
COMMIT;

SET AUTOCOMMIT=0;
INSERT INTO VAHP VALUES ('VAH001','2023-02-01',10000.00,'SUR'),
('VAH002','2023-02-01',10000.00,'SUR'),
('VAH003','2023-02-01',10000.00,'SUR'),
('VAH004','2023-02-01',10000.00,'SUR'),
('VAH005','2023-02-01',10000.00,'SUR'),
('VAH006','2023-02-01',10000.00,'KUT'),
('VAH007','2023-02-01',10000.00,'KUT'),
('VAH008','2023-02-01',10000.00,'KUT'),
('VAH009','2023-02-01',10000.00,'KUT'),
('VAH010','2023-02-01',10000.00,'KUT'),
('VAH011','2023-02-01',10000.00,'AND'),
('VAH012','2023-02-01',10000.00,'AND'),
('VAH013','2023-02-01',10000.00,'AMD'),
('VAH014','2023-02-01',10000.00,'AND'),
('VAH015','2023-02-01',10000.00,'AND');
COMMIT;
